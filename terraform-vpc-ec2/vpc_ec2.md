...
I have also recorded an updated version to reflect these changes. You will find it right after this announcement. In any case, I'm leaving the steps here in case some of you want to try them individually before going through the recording.

A quick heads-up: these changes mostly make the concrete hands-on steps of the upcoming lecture ("VPC and EC2 Project - Deploying a Bitnami NGINX EC2 Instance") unnecessary, since you will already have done them here. It is still very much worth watching that lecture, though, as it includes useful discussions that go beyond the steps themselves.
